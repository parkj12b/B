...
void test_ht_create_and_destroy()
{
	...
	{
		oprintf("test_ht_create_and_destroy: FAILED\n");
		return;
	}
	ht_destroy_table(table);
	oprintf("test_ht_create_and_destroy: PASSED\n");
}
...
void test_ht_insert_and_search()
{
	...
	{
		oprintf("test_ht_insert_and_search: FAILED\n");
		ht_destroy_table(table);
		return;
	}

	ht_destroy_table(table);
	oprintf("test_ht_insert_and_search: PASSED\n");
}
...
void test_ht_delete()
{
	...
	{
		oprintf("test_ht_delete: FAILED\n");
		ht_destroy_table(table);
		return;
	}

	ht_destroy_table(table);
	oprintf("test_ht_delete: PASSED\n");
}
...
void test_ht_expand_table()
{
	...
	{
		oprintf("test_ht_expand_table: FAILED\n");
		ht_destroy_table(table);
		return;
	}

	ht_destroy_table(table);
	oprintf("test_ht_expand_table: PASSED\n");
}
...
void test_ht_shrink_table()
{
	...
	{
		oprintf("test_ht_shrink_table: PASSED\n");
		ht_destroy_table(table);
		return;
	}

	oprintf("test_ht_shrink_table: FAILED\n");
	ht_destroy_table(table);
}
